...
export const BuySellPanel: React.FC<BuySellPanelProps> = ({
  ...
  return (
    <div className="glass-card p-5 space-y-5 relative">
      ...
      <div className="grid grid-cols-2 gap-2 p-1 bg-slate-900/80 rounded-xl border border-white/10">
        <button
          ...
          className={`py-2.5 rounded-lg font-bold text-xs flex items-center justify-center gap-2 transition-all ${
            orderType === 'BUY'
              ? 'gradient-btn-green text-black shadow-lg shadow-emerald-500/20'
        ...
        <button
          ...
          className={`py-2.5 rounded-lg font-bold text-xs flex items-center justify-center gap-2 transition-all ${
            orderType === 'SELL'
              ? 'gradient-btn-red text-white shadow-lg shadow-rose-500/20'
              : 'text-slate-400 hover:text-white'
          }`}
        >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full glass-input font-mono font-bold text-white text-sm"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full glass-input font-mono font-bold text-white text-sm disabled:opacity-50"
          />
        </div>
      </div>

      {/* Target & Stop Loss (Bracket / Cover Order) */}
        ...
        <div className="grid grid-cols-2 gap-3 bg-slate-900/40 p-3 rounded-xl border border-white/5">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full glass-input py-1.5 font-mono text-xs text-white"
            />
          </div>
          <div className="space-y-1">
      ...
      <div className="bg-slate-950/60 p-3.5 rounded-xl border border-white/5 space-y-2 text-xs">
        ...
        <div className="grid grid-cols-2 gap-y-1 text-[11px] text-slate-300">
          ...
          <div className="flex justify-between">
            <span className="text-slate-400">Exchange Turnover Fee</span>
            <span className="font-mono">₹{charges.exchangeTurnover.toFixed(2)}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-400">GST (18%) + Stamp Duty</span>
      ...
      <button
        ...
        className={`w-full py-3.5 font-extrabold text-sm uppercase tracking-wider ${
          orderType === 'BUY' ? 'gradient-btn-green' : 'gradient-btn-red'
        }`}
      >
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl font-bold text-xs text-black ${
                  orderType === 'BUY' ? 'gradient-btn-green' : 'gradient-btn-red text-white'
                }`}
              >
