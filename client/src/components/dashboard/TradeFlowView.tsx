...
interface TradeFlowViewProps {
  onOrderExecuted: (orderData: any) => void;
}

export const TradeFlowView: React.FC<TradeFlowViewProps> = ({ onOrderExecuted }) => {
  const [activeSideTab, setActiveSideTab] = useState<string>('Portfolio Overview');
  ...
  return (
    <div className="flex gap-6">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* CARD 2: STOCK PRICE LINE CHART WITH TRADE MARKERS */}
        <div className="glass-card p-5 space-y-4">
          ...
          {/* Line Chart with Glowing Trade Markers */}
        ...
        {/* CARD 3: BALANCE & ACTIONS + QUICK ACTIONS */}
        <div className="space-y-6">
          ...
          <div className="glass-card p-5 space-y-4">
            ...
            {/* Vibrant Emerald Available Balance Box */}
